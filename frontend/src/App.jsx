...
const Layout = ({ children }) => {
  ...
  return (
    // "w-full" ensures the background stretches across the whole screen
    <div className="min-h-screen w-full bg-slate-50">
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
              {/* If you don't have Lucide icons installed, remove the <Activity /> tag */}
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={handleLogout} className="text-slate-500 hover:text-red-600 hover:bg-red-50 px-3 py-2 rounded-lg transition-colors text-sm font-medium">
                Logout
              </button>
            </div>
          </div>
      ...
      {/* This main container controls the width of your page content */}
